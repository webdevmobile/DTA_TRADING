                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-7">
                            <div class="card">
                                ...
                                <div class="content">
                                    <form  action="{{ route('admin.training.forms.store') }}" method="post">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                @include('shared.input', ['label' => 'Nom de la formation', 'name' => 'name', 'placeholder' => 'Entrez le nom de la formation'])
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-12">
